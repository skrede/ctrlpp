// Usage: gnuplot -p -e "set datafile separator ','; set key autotitle columnheader; plot '<./ctrlpp_pid_03_cascade' using 1:2 with lines title 'pos setpoint', '' using 1:3 with lines title 'position', '' using 1:6 with lines title 'torque'"
