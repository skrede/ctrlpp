// Usage: ./ctrlpp_trajectory_01_cubic | gnuplot -p -e "set datafile separator ','; set key autotitle columnheader; plot '-' using 1:2 with lines title 'joint1', '' using 1:4 with lines title 'joint2'"
