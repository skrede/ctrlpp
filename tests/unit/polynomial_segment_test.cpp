...
static_assert(ctrlpp::trajectory_segment<ctrlpp::cubic_segment<double, 1>, double, 1>);
static_assert(ctrlpp::trajectory_segment<ctrlpp::quintic_segment<double, 1>, double, 1>);
static_assert(ctrlpp::trajectory_segment<ctrlpp::septic_segment<double, 1>, double, 1>);
static_assert(ctrlpp::trajectory_segment<ctrlpp::cubic_segment<double, 3>, double, 3>);

// ---- Cubic segment tests ----

TEST_CASE("cubic_segment rest-to-rest boundary conditions", "[traj][polynomial]")
{
    ...
    auto seg = ctrlpp::make_cubic_segment(q0, q1, v0, v1, 2.0);
...
TEST_CASE("cubic_segment midpoint symmetry", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    Vector<double, 1> v0 = Vector<double, 1>::Zero();
...
TEST_CASE("cubic_segment boundary clamping", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    Vector<double, 1> v0 = Vector<double, 1>::Zero();
...
TEST_CASE("cubic_segment non-zero velocity BCs", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    ...
    auto seg = ctrlpp::make_cubic_segment(q0, q1, v0, v1, 4.0);
...
TEST_CASE("cubic_segment duration()", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    Vector<double, 1> v0 = Vector<double, 1>::Zero();
...
// ---- Quintic segment tests ----

TEST_CASE("quintic_segment rest-to-rest boundary conditions", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    Vector<double, 1> v0 = Vector<double, 1>::Zero();
    ...
    auto seg = ctrlpp::make_quintic_segment(q0, q1, v0, v1, a0, a1, 2.0);
...
TEST_CASE("quintic_segment midpoint symmetry", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    Vector<double, 1> zero = Vector<double, 1>::Zero();

    auto seg = ctrlpp::make_quintic_segment(q0, q1, zero, zero, zero, zero, 2.0);
    auto pm = seg.evaluate(1.0);
    CHECK_THAT(pm.position[0], WithinAbs(5.0, 1e-10));
}

TEST_CASE("quintic_segment boundary clamping", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    Vector<double, 1> zero = Vector<double, 1>::Zero();
...
TEST_CASE("quintic_segment non-zero BCs", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    ...
    auto seg = ctrlpp::make_quintic_segment(q0, q1, v0, v1, a0, a1, 3.0);
...
// ---- Septic segment tests ----

TEST_CASE("septic_segment rest-to-rest boundary conditions", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    Vector<double, 1> zero = Vector<double, 1>::Zero();

    auto seg = ctrlpp::make_septic_segment(q0, q1, zero, zero, zero, zero, zero, zero, 2.0);
...
TEST_CASE("septic_segment midpoint symmetry", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    Vector<double, 1> zero = Vector<double, 1>::Zero();
...
TEST_CASE("septic_segment boundary clamping", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    Vector<double, 1> zero = Vector<double, 1>::Zero();
...
TEST_CASE("septic_segment non-zero jerk BCs", "[traj][polynomial]")
{
    Vector<double, 1> q0 = Vector<double, 1>::Zero();
    Vector<double, 1> q1 = Vector<double, 1>::Constant(10.0);
    Vector<double, 1> zero = Vector<double, 1>::Zero();
    ...
    auto seg = ctrlpp::make_septic_segment(q0, q1, zero, zero, zero, zero, j0, j1, 2.0);

    // Positions and velocities still correct at endpoints
    CHECK_THAT(seg.evaluate(0.0).position[0], WithinAbs(0.0, 1e-12));
...
TEST_CASE("cubic_segment ND=3 independent axes", "[traj][polynomial]")
{
    Vector<double, 3> q0;
    q0 << 0.0, 0.0, 0.0;
    Vector<double, 3> q1;
