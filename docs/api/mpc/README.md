...
programs via NLopt. Solver backends are injected via C++23 concepts &mdash; you can
...
- [mpc](mpc.md)<br/> Linear model predictive control (sparse QP, OSQP backend)
- [nmpc](nmpc.md)<br/> Nonlinear model predictive control (multiple shooting, NLopt backend)

### Estimators

- [mhe](mhe.md)<br/> Linear moving horizon estimation (OSQP backend)
- [nmhe](nmhe.md)<br/> Nonlinear moving horizon estimation (NLopt backend)
...
Pick **mhe** or **nmhe** when you need constrained state estimation &mdash; the MHE
