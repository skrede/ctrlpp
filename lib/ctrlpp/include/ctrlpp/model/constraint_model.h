#ifndef HPP_GUARD_CTRLPP_MODEL_CONSTRAINT_MODEL_H
#define HPP_GUARD_CTRLPP_MODEL_CONSTRAINT_MODEL_H
...
concept constraint_model = requires(const G& g, const Vector<Scalar, NX>& x, const Vector<Scalar, NU>& u) {
...
concept terminal_constraint_model = requires(const H& h, const Vector<Scalar, NX>& x) {
