#ifndef HPP_GUARD_CTRLPP_TRAJ_SEPTIC_SEGMENT_H
#define HPP_GUARD_CTRLPP_TRAJ_SEPTIC_SEGMENT_H
...
/// @brief Create septic segment from boundary conditions q, dq, ddq, d3q at both endpoints.
///
/// Coefficients derived from B&M eq. (2.6) in normalized time tau = t/T.
template <typename Scalar, int Rows>
auto make_septic_segment(
    ...
    Scalar duration) -> septic_segment<Scalar, static_cast<std::size_t>(Rows)>
{
...
static_assert(trajectory_segment<septic_segment<double, 1>, double, 1>);
