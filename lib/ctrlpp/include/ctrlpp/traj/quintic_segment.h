#ifndef HPP_GUARD_CTRLPP_TRAJ_QUINTIC_SEGMENT_H
#define HPP_GUARD_CTRLPP_TRAJ_QUINTIC_SEGMENT_H
...
/// @brief Create quintic segment from boundary conditions q, dq, ddq at both endpoints.
///
/// Coefficients derived from B&M eq. (2.5) in normalized time tau = t/T.
template <typename Scalar, int Rows>
auto make_quintic_segment(
    ...
    Scalar duration) -> quintic_segment<Scalar, static_cast<std::size_t>(Rows)>
{
...
static_assert(trajectory_segment<quintic_segment<double, 1>, double, 1>);
