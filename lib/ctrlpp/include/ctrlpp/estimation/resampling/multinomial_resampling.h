#ifndef HPP_GUARD_CTRLPP_ESTIMATION_RESAMPLING_MULTINOMIAL_RESAMPLING_H
#define HPP_GUARD_CTRLPP_ESTIMATION_RESAMPLING_MULTINOMIAL_RESAMPLING_H

/// @brief Multinomial resampling for particle filters.
///
