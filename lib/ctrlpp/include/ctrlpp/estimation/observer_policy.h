#ifndef HPP_GUARD_CTRLPP_ESTIMATION_OBSERVER_POLICY_H
#define HPP_GUARD_CTRLPP_ESTIMATION_OBSERVER_POLICY_H
...
concept ObserverPolicy =
    requires
    {
        typename O::observer_tag;typename O::state_vector_t;typename O::input_vector_t;typename O::output_vector_t;
    } &&
