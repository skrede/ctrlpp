#ifndef HPP_GUARD_CTRLPP_MPC_DIFFERENTIABLE_MEASUREMENT_H
#define HPP_GUARD_CTRLPP_MPC_DIFFERENTIABLE_MEASUREMENT_H
...
concept differentiable_measurement = measurement_model<M, Scalar, NX, NY> &&
    requires(const M& m,
