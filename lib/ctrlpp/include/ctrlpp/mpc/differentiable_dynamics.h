#ifndef HPP_GUARD_CTRLPP_MPC_DIFFERENTIABLE_DYNAMICS_H
#define HPP_GUARD_CTRLPP_MPC_DIFFERENTIABLE_DYNAMICS_H
...
concept differentiable_dynamics = dynamics_model<D, Scalar, NX, NU> &&
    requires(const D& d,
