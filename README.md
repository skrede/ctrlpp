...
**NB:** This library is still under development and have not undergone rigorous real-world testing beyond the extensive test suite under `tests/`. Reports and experiences use and testing of this library will be appreciated.
