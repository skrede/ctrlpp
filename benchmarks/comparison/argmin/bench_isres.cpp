                   ...
                   ctrlpp::warm_start_mode ws_mode)
{
    ...
    ctrlpp::nmpc_dynamic<double, NX, NU, ArgminIsres, Dynamics> nmpc_argmin{dynamics, config};
    ...
    ctrlpp::nmpc_dynamic<double, NX, NU, ArgminIsres, Dynamics> q_argmin{dynamics, config};
