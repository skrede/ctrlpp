...
#                     Valid: libmpc,osqp_eigen,hpipm,ct,ruckig,drake,argmin,argmin-mma,argmin-gcmma
        ...
        --comparison)
            ...
            for comp in "${COMPETITORS[@]}"; do
                case "$comp" in
                    ...
                    argmin-mma)     CMAKE_OPTS+=" -DCTRLPP_BENCH_ARGMIN=ON" ;;
                    argmin-gcmma)   CMAKE_OPTS+=" -DCTRLPP_BENCH_ARGMIN=ON" ;;
